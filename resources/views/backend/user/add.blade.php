        ...
        <form method="get" action="<?php echo URL::to('/user/save/'); ?>">
            ...
            <div class="maincontent">
                ...
                <div class="form-field clearfix">
                    ...
                    <div class="form-value"><input type="text" name="name" class="" value=""></div>
                </div>
                <div class="form-field clearfix">
                    <label>Email</label>
                    <div class="form-value"><input type="email" name="email" class="" value=""></div>
                </div>
                <div class="form-field clearfix">
                    <label>Password</label>
                    <div class="form-value"><input type="password" name="password" class="" value=""></div>
                </div>
{{--                <div class="form-field clearfix">--}}
{{--                    <label>2</label>--}}
